...
# Tabela de preços (definida pelo aluno)
precos_diaria = {
    "uno": 30.0,
    "gol": 40.0,
    "bmw": 1000.0,
...
# valor por dia (com padrão caso não exista)
if modelo in precos_diaria:
    valor_dia = precos_diaria[modelo]
else:
    valor_dia = 50.0  # preço padrão
